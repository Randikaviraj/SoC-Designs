...
# Memory: instruction_mem_2
MEM_0 := SoC_instruction_mem_2
$(MEM_0)_NAME := instruction_mem_2
...
$(MEM_0)_HIERARCHICAL_PATH := instruction_mem_2
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: instruction_mem_2
instruction_mem_2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
