...
# Memory: onchip_instrucrion_memory0
MEM_1 := SoC_onchip_instrucrion_memory0
$(MEM_1)_NAME := onchip_instrucrion_memory0
...
$(MEM_1)_END := 0x00057fff
$(MEM_1)_HIERARCHICAL_PATH := onchip_instrucrion_memory0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_instrucrion_memory0
onchip_instrucrion_memory0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
